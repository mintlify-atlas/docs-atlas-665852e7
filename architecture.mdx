...
description: 'Understanding the layered architecture of SaludYa API'
---

# Architecture Overview

SaludYa API follows a clean, layered architecture pattern that promotes separation of concerns, maintainability, and testability. The architecture is divided into three main layers: Controller, Service, and Repository.
