---
title: 'Quickstart'
description: 'Make your first API call to SaludYa in under 5 minutes'
---

## Welcome to SaludYa API

This guide will help you make your first API call to manage medical appointments. You'll learn how to authenticate, retrieve patient information, and create an appointment.

## Prerequisites

Before you begin, ensure you have:
- An API key from your [SaludYa Dashboard](https://dashboard.saludya.com)
- A tool to make HTTP requests (curl, Postman, or your preferred HTTP client)

<Steps>
  <Step title="Get Your API Key">
    Log in to your [SaludYa Dashboard](https://dashboard.saludya.com) and navigate to **Settings > API Keys**. Create a new API key and copy it securely.
...
<CardGroup cols={2}>
  <Card title="Support" icon="life-ring" href="mailto:support@saludya.com">
    Contact our support team
  </Card>
  <Card title="Community" icon="users" href="https://community.saludya.com">
